...
namespace Equisoft\SDK\EquisoftPlan;

use GuzzleHttp\Psr7\Utils;
use Equisoft\SDK\EquisoftPlan\Model\ModelInterface;
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                if (isset($class::DISCRIMINATOR_MAP[$data->{$discriminator}])) {
                    $subclass = '\Equisoft\SDK\EquisoftPlan\Model\\' . $class::DISCRIMINATOR_MAP[$data->{$discriminator}];
                } else {
                    $subclass = '\Equisoft\SDK\EquisoftPlan\Model\\' . $data->{$discriminator};
                }
