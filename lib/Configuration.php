...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/8.13.3-SNAPSHOT/PHP';
    ...
    {
        $report  = 'PHP SDK (Equisoft\SDK\EquisoftPlan) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: latest' . PHP_EOL;
        $report .= '    SDK Package Version: 8.13.3-SNAPSHOT' . PHP_EOL;
