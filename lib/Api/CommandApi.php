...
class CommandApi
{
     ...
     */
    public function cmdCopyFNA($cmdCopyFNA)
    {
        list($response) = $this->cmdCopyFNAWithHttpInfo($cmdCopyFNA);
        return $response;
    }
     ...
     */
    public function cmdCopyFNAWithHttpInfo($cmdCopyFNA)
    {
        $request = $this->cmdCopyFNARequest($cmdCopyFNA);
     ...
     */
    public function cmdCopyFNAAsync($cmdCopyFNA)
    {
        return $this->cmdCopyFNAAsyncWithHttpInfo($cmdCopyFNA)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cmdCopyFNAAsyncWithHttpInfo($cmdCopyFNA)
    {
        $returnType = '\Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNAResponse';
        $request = $this->cmdCopyFNARequest($cmdCopyFNA);
     ...
     */
    public function cmdCopyFNARequest($cmdCopyFNA)
    {
        ...
        if (isset($cmdCopyFNA)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($cmdCopyFNA));
            } else {
                $httpBody = $cmdCopyFNA;
            }
