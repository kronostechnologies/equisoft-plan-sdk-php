...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updatePlanExternalId'] to see the possible values for this operation
     *
     * @throws \Equisoft\SDK\EquisoftPlan\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updatePlanExternalId($fnaUuid, $clientUuid, $body, string $contentType = self::contentTypes['updatePlanExternalId'][0])
    {
        $this->updatePlanExternalIdWithHttpInfo($fnaUuid, $clientUuid, $body, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePlanExternalIdWithHttpInfo($fnaUuid, $clientUuid, $body, string $contentType = self::contentTypes['updatePlanExternalId'][0])
    {
        $request = $this->updatePlanExternalIdRequest($fnaUuid, $clientUuid, $body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePlanExternalIdAsync($fnaUuid, $clientUuid, $body, string $contentType = self::contentTypes['updatePlanExternalId'][0])
    {
        return $this->updatePlanExternalIdAsyncWithHttpInfo($fnaUuid, $clientUuid, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePlanExternalIdAsyncWithHttpInfo($fnaUuid, $clientUuid, $body, string $contentType = self::contentTypes['updatePlanExternalId'][0])
    {
        $returnType = '';
        $request = $this->updatePlanExternalIdRequest($fnaUuid, $clientUuid, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePlanExternalIdRequest($fnaUuid, $clientUuid, $body, string $contentType = self::contentTypes['updatePlanExternalId'][0])
    {
