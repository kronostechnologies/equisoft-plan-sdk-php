...
class UsersApi
{
     ...
     * @return void
     */
    public function deleteUser($userAccountUuid, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $this->deleteUserWithHttpInfo($userAccountUuid, $contentType);
    }
     ...
     */
    public function deleteUserWithHttpInfo($userAccountUuid, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsync($userAccountUuid, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsyncWithHttpInfo($userAccountUuid, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $returnType = '';
        $request = $this->deleteUserRequest($userAccountUuid, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteUserRequest($userAccountUuid, string $contentType = self::contentTypes['deleteUser'][0])
    {
