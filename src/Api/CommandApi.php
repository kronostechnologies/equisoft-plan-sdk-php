...
class CommandApi
{
     ...
     * @return \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNAResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function cmdCopyFNA(
        \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNA $cmdCopyFNA,
        string $contentType = self::contentTypes['cmdCopyFNA'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNAResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
     ...
     */
    public function cmdCopyFNAWithHttpInfo(
        \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNA $cmdCopyFNA,
        string $contentType = self::contentTypes['cmdCopyFNA'][0]
    ): array
    {
     ...
     */
    public function cmdCopyFNAAsync(
        \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNA $cmdCopyFNA,
        string $contentType = self::contentTypes['cmdCopyFNA'][0]
    ): PromiseInterface
    {
     ...
     * @return PromiseInterface
     */
    public function cmdCopyFNAAsyncWithHttpInfo(
        \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNA $cmdCopyFNA,
        string $contentType = self::contentTypes['cmdCopyFNA'][0]
    ): PromiseInterface
    {
     ...
     */
    public function cmdCopyFNARequest(
        \Equisoft\SDK\EquisoftPlan\Model\CmdCopyFNA $cmdCopyFNA,
        string $contentType = self::contentTypes['cmdCopyFNA'][0]
    ): Request
    {
