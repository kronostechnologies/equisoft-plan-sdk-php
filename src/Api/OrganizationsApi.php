...
class OrganizationsApi
{
     ...
     * @return \Equisoft\SDK\EquisoftPlan\Model\OrganizationsCreateOrganizationResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function createOrganization(
        \Equisoft\SDK\EquisoftPlan\Model\OrganizationsCreateOrganizationPayload $organizationsCreateOrganizationPayload,
        string $contentType = self::contentTypes['createOrganization'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\OrganizationsCreateOrganizationResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftPlan\Model\OrganizationsListOrganizationsResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function listOrganizations(
        string $organizationUuid,
        string $contentType = self::contentTypes['listOrganizations'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\OrganizationsListOrganizationsResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
