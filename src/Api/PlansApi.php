...
class PlansApi
{
     ...
     * @return \Equisoft\SDK\EquisoftPlan\Model\PlansListPlansResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function listPlans(
        ?string $clientExternalUuid = null,
        string $contentType = self::contentTypes['listPlans'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\PlansListPlansResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
