...
class UsersApi
{
     ...
     * Operation moveUser
     *
     * @param  string $uuid Account organization uuid of the destination organization (required)
     * @param  string $userUuid User account uuid of the user to move (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveUser'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftPlan\Model\UserMoveUserResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function moveUser(
        string $uuid,
        string $userUuid,
        string $contentType = self::contentTypes['moveUser'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\UserMoveUserResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
        list($response) = $this->moveUserWithHttpInfo($uuid, $userUuid, $contentType);
        return $response;
    }

    /**
     * Operation moveUserWithHttpInfo
     *
     * @param  string $uuid Account organization uuid of the destination organization (required)
     * @param  string $userUuid User account uuid of the user to move (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveUser'] to see the possible values for this operation
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \Equisoft\SDK\EquisoftPlan\Model\UserMoveUserResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function moveUserWithHttpInfo(
        string $uuid,
        string $userUuid,
        string $contentType = self::contentTypes['moveUser'][0]
    ): array
    {
        $request = $this->moveUserRequest($uuid, $userUuid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Equisoft\SDK\EquisoftPlan\Model\UserMoveUserResponse',
                        $request,
                        $response,
                    );
                case 401:
     ...
     * @return PromiseInterface
     */
    public function moveUserAsync(
        string $uuid,
        string $userUuid,
        string $contentType = self::contentTypes['moveUser'][0]
    ): PromiseInterface
    {
        return $this->moveUserAsyncWithHttpInfo($uuid, $userUuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation moveUserAsyncWithHttpInfo
     *
     * @param  string $uuid Account organization uuid of the destination organization (required)
     * @param  string $userUuid User account uuid of the user to move (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveUser'] to see the possible values for this operation
     ...
     * @return PromiseInterface
     */
    public function moveUserAsyncWithHttpInfo(
        string $uuid,
        string $userUuid,
        string $contentType = self::contentTypes['moveUser'][0]
    ): PromiseInterface
    {
        $returnType = '\Equisoft\SDK\EquisoftPlan\Model\UserMoveUserResponse';
        $request = $this->moveUserRequest($uuid, $userUuid, $contentType);
    ...
    /**
     * Create request for operation 'moveUser'
     *
     * @param  string $uuid Account organization uuid of the destination organization (required)
     * @param  string $userUuid User account uuid of the user to move (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveUser'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function moveUserRequest(
        string $uuid,
        string $userUuid,
        string $contentType = self::contentTypes['moveUser'][0]
    ): Request
    {
        ...
        if ($uuid === null || (is_array($uuid) && count($uuid) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $uuid when calling moveUser'
            );
        }
        ...
        if ($userUuid === null || (is_array($userUuid) && count($userUuid) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $userUuid when calling moveUser'
            );
        }


        $resourcePath = '/fna/api/v2/organizations/{uuid}/users/{userUuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
