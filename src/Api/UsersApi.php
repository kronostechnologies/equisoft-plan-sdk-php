...
class UsersApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Equisoft\SDK\EquisoftPlan\Model\UsersUserContext|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
     */
    public function getUserContext(
        string $contentType = self::contentTypes['getUserContext'][0]
    ): \Equisoft\SDK\EquisoftPlan\Model\UsersUserContext|\Equisoft\SDK\EquisoftPlan\Model\ErrorResponse
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserContextRequest(
        string $contentType = self::contentTypes['getUserContext'][0]
    ): Request
    {
