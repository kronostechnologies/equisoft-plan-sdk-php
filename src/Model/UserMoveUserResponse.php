...
/**
 * UserMoveUserResponse Class Doc Comment
 *
 * @description Move user response
 * @package  Equisoft\SDK\EquisoftPlan
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements ArrayAccess<string, mixed>
 */
class UserMoveUserResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'user.MoveUserResponse';
    ...
    {
        $this->setIfExists('userUuid', $data ?? [], null);
        $this->setIfExists('organizationUuid', $data ?? [], null);
        $this->setIfExists('moved', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['moved'] === null) {
            $invalidProperties[] = "'moved' can't be null";
        }
     ...
     * Sets userUuid
     *
     * @param string $userUuid User account uuid of the moved user
     *
     * @return $this
     */
    ...
    {
        if (is_null($userUuid)) {
            throw new InvalidArgumentException('non-nullable userUuid cannot be null');
        }
     ...
     *
     * @param string $organizationUuid Account organization uuid of the destination organization
     *
     * @return $this
     */
     ...
     * Sets moved
     *
     * @param bool $moved False when the user was already in the destination organization
     *
     * @return $this
     */
    public function setMoved(bool $moved): static
    {
        if (is_null($moved)) {
            throw new InvalidArgumentException('non-nullable moved cannot be null');
        }
