...
class CmdCopyFNA implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'cmd.CopyFNA';
    ...
    */
     ...
     * @return string
     */
    public function getFnaUuid(): string
    {
     ...
     * @return $this
     */
    public function setFnaUuid(string $fnaUuid): static
    {
        if (is_null($fnaUuid)) {
     ...
     */
    public function getNewParticipantUuids(): ?array
    {
     ...
     * @return $this
     */
    public function setNewParticipantUuids(?array $newParticipantUuids): static
    {
