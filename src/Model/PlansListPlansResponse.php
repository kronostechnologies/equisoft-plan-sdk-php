...
class PlansListPlansResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'plans.ListPlansResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('createPlanUrl', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string
     */
    public function getCreatePlanUrl(): string
    {
     ...
     * @return $this
     */
    public function setCreatePlanUrl(string $createPlanUrl): static
    {
        if (is_null($createPlanUrl)) {
            throw new InvalidArgumentException('non-nullable createPlanUrl cannot be null');
        }
