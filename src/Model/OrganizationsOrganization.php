...
/**
 * OrganizationsOrganization Class Doc Comment
 *
 * @package  Equisoft\SDK\EquisoftPlan
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class OrganizationsOrganization implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'organizations.Organization';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('externalDatabase', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets externalDatabase
     *
     * @return string|null
     */
    public function getExternalDatabase(): ?string
    {
        return $this->container['externalDatabase'];
    }

    /**
     * Sets externalDatabase
     *
     * @param string|null $externalDatabase externalDatabase
     *
     * @return $this
     */
    public function setExternalDatabase(?string $externalDatabase): static
    {
        if (is_null($externalDatabase)) {
            array_push($this->openAPINullablesSetToNull, 'externalDatabase');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('externalDatabase', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['externalDatabase'] = $externalDatabase;
     ...
     *
     * @param string|null $organizationUuid organizationUuid
     *
     * @return $this
     */
